...
def send_alert_email(subject, body):
    ...
    password = "your-email-password"  # Use secrets in production
...
# -------------------- FOOTER --------------------
st.markdown("---")
st.caption("Built for India’s Smart Governance • Privacy-Safe • Scalable • Open Source")    st.title(" Real-Time Surge & Anomaly Alerts")
    if len(data) < 10:
        st.warning("Not enough data for anomaly detection.")
    else:
        model = IsolationForest(contamination=0.1)
